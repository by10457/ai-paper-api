...
PYPI_TRUSTED_HOST="${PYPI_TRUSTED_HOST:-mirrors.cloud.tencent.com}"
...
Optional environment variables:
  ...
  PYPI_INDEX_URL    Python package mirror for uv/pip (default: https://mirrors.cloud.tencent.com/pypi/simple/)
  PYPI_TRUSTED_HOST Python package mirror trusted host (default: mirrors.cloud.tencent.com)
